...
export const { useGetNowPlayingMovieQuery, useGetPouplarMovieQuery, useSearchMovieQuery, useGetTopRatedMovieQuery, useGetUpcomingMovieQuery, useGetMovieDetailsQuery } = movieApi