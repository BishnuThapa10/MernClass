...
import { useGetUpcomingMovieQuery } from "./movieApi";
...
export default function UpcomingMovie() {
    ...
    const {isLoading, data, error} = useGetUpcomingMovieQuery(page);
  ...
  return (
    <div>
      ...
      <h1 className="pl-4 text-xl font-semibold p-2">Upcoming Movies</h1>
